...
namespace Projeto_Jardim_Escola.Data.Migrations
{
    ...
    [Migration("20230621142825_migracaoFinal")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "805ffdd9-df1e-4c48-8699-e1dc4a1dad82",
                            Email = "admin@jardimescola.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@JARDIMESCOLA.COM",
                            NormalizedUserName = "ADMIN@JARDIMESCOLA.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEGr02grSJDsrthGGjFuQlKoqNitxt3qZkwP35tF2dmeU9hfLT7AGkE7WjbB1vd8V+A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "4d251605-a817-4d22-9fae-74e0fef92075",
            ...
            modelBuilder.Entity("Projeto_Jardim_Escola.Models.AnoLetivo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NomeAnoLetivo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            NomeAnoLetivo = "2021-2022"
                        },
                        new
                        {
                            Id = 2,
                            NomeAnoLetivo = "2022-2023"
                        },
                        new
                        {
                            Id = 3,
                            NomeAnoLetivo = "2023-2024"
                        },
                        new
                        {
                            Id = 4,
                            NomeAnoLetivo = "2024-2025"
                        });
                });

            modelBuilder.Entity("Projeto_Jardim_Escola.Models.Pessoa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projeto_Jardim_Escola.Models.TipoIdentificacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projeto_Jardim_Escola.Models.Turma", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projeto_Jardim_Escola.Models.Aluno", b =>
                {
                    b.HasBaseType("Projeto_Jardim_Escola.Models.Pessoa");
                    ...
                    b.ToTable("Pessoas", t =>
                        {
                            ...
                            t.Property("Telemovel")
                                .HasColumnName("Responsavel_Telemovel");

                            t.Property("UserID")
                                .HasColumnName("Responsavel_UserID");
                        });
            ...
            modelBuilder.Entity("AlunoTurma", b =>
                {
                    b.HasOne("Projeto_Jardim_Escola.Models.Aluno", null)
                        .WithMany()
                        .HasForeignKey("AlunosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Projeto_Jardim_Escola.Models.Turma", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Projeto_Jardim_Escola.Models.Pessoa", b =>
                {
                    b.HasOne("Projeto_Jardim_Escola.Models.TipoIdentificacao", "TipoIdentificacao")
                        .WithMany("Pessoas")
            ...
            modelBuilder.Entity("Projeto_Jardim_Escola.Models.Turma", b =>
                {
                    b.HasOne("Projeto_Jardim_Escola.Models.AnoLetivo", "AnoLetivo")
                        .WithMany("Turmas")
